...
GRANT USAGE ON SCHEMA app_hidden TO theopenpresenter_visitor;
...
GRANT USAGE ON SCHEMA app_public TO theopenpresenter_visitor;
...
GRANT USAGE ON SCHEMA public TO theopenpresenter_visitor;
...
GRANT SELECT ON TABLE app_public.users TO theopenpresenter_visitor;
...
GRANT UPDATE(username) ON TABLE app_public.users TO theopenpresenter_visitor;
...
GRANT UPDATE(name) ON TABLE app_public.users TO theopenpresenter_visitor;
...
GRANT UPDATE(avatar_url) ON TABLE app_public.users TO theopenpresenter_visitor;
...
GRANT ALL ON FUNCTION app_public.accept_invitation_to_organization(invitation_id uuid, code text) TO theopenpresenter_visitor;
...
GRANT ALL ON FUNCTION app_public.change_password(old_password text, new_password text) TO theopenpresenter_visitor;
...
GRANT SELECT ON TABLE app_public.organizations TO theopenpresenter_visitor;
...
GRANT UPDATE(slug) ON TABLE app_public.organizations TO theopenpresenter_visitor;
...
GRANT UPDATE(name) ON TABLE app_public.organizations TO theopenpresenter_visitor;
...
GRANT ALL ON FUNCTION app_public.current_session_id() TO theopenpresenter_visitor;
...
GRANT ALL ON FUNCTION app_public.current_user_id() TO theopenpresenter_visitor;
...
GRANT ALL ON FUNCTION app_public.current_user_invited_organization_ids() TO theopenpresenter_visitor;
...
GRANT ALL ON FUNCTION app_public.current_user_member_organization_ids() TO theopenpresenter_visitor;
...
GRANT ALL ON FUNCTION app_public.delete_organization(organization_id uuid) TO theopenpresenter_visitor;
...
GRANT ALL ON FUNCTION app_public.forgot_password(email public.citext) TO theopenpresenter_visitor;
...
GRANT ALL ON FUNCTION app_public.invite_to_organization(organization_id uuid, username public.citext, email public.citext) TO theopenpresenter_visitor;
...
GRANT ALL ON FUNCTION app_public.logout() TO theopenpresenter_visitor;
...
GRANT SELECT,DELETE ON TABLE app_public.user_emails TO theopenpresenter_visitor;
...
GRANT INSERT(email) ON TABLE app_public.user_emails TO theopenpresenter_visitor;
...
GRANT ALL ON FUNCTION app_public.make_email_primary(email_id uuid) TO theopenpresenter_visitor;
...
GRANT ALL ON FUNCTION app_public.organization_for_invitation(invitation_id uuid, code text) TO theopenpresenter_visitor;
...
GRANT ALL ON FUNCTION app_public.organizations_current_user_is_billing_contact(org app_public.organizations) TO theopenpresenter_visitor;
...
GRANT ALL ON FUNCTION app_public.organizations_current_user_is_owner(org app_public.organizations) TO theopenpresenter_visitor;
...
GRANT ALL ON FUNCTION app_public.remove_from_organization(organization_id uuid, user_id uuid) TO theopenpresenter_visitor;
...
GRANT ALL ON FUNCTION app_public.tg__graphql_subscription() TO theopenpresenter_visitor;
...
GRANT ALL ON FUNCTION app_public.tg_user_emails__forbid_if_verified() TO theopenpresenter_visitor;
...
GRANT ALL ON FUNCTION app_public.tg_user_emails__prevent_delete_last_email() TO theopenpresenter_visitor;
...
GRANT ALL ON FUNCTION app_public.tg_user_emails__verify_account_on_verified() TO theopenpresenter_visitor;
...
GRANT ALL ON FUNCTION app_public.tg_users__deletion_organization_checks_and_actions() TO theopenpresenter_visitor;
...
GRANT ALL ON FUNCTION app_public.transfer_organization_billing_contact(organization_id uuid, user_id uuid) TO theopenpresenter_visitor;
...
GRANT ALL ON FUNCTION app_public.users_has_password(u app_public.users) TO theopenpresenter_visitor;
...
GRANT SELECT,DELETE ON TABLE app_public.user_authentications TO theopenpresenter_visitor;
...
ALTER DEFAULT PRIVILEGES FOR ROLE theopenpresenter IN SCHEMA app_hidden GRANT SELECT,USAGE ON SEQUENCES TO theopenpresenter_visitor;
...
ALTER DEFAULT PRIVILEGES FOR ROLE theopenpresenter IN SCHEMA app_hidden GRANT ALL ON FUNCTIONS TO theopenpresenter_visitor;
...
ALTER DEFAULT PRIVILEGES FOR ROLE theopenpresenter IN SCHEMA app_public GRANT SELECT,USAGE ON SEQUENCES TO theopenpresenter_visitor;
...
ALTER DEFAULT PRIVILEGES FOR ROLE theopenpresenter IN SCHEMA app_public GRANT ALL ON FUNCTIONS TO theopenpresenter_visitor;
...
ALTER DEFAULT PRIVILEGES FOR ROLE theopenpresenter IN SCHEMA public GRANT SELECT,USAGE ON SEQUENCES TO theopenpresenter_visitor;
...
ALTER DEFAULT PRIVILEGES FOR ROLE theopenpresenter IN SCHEMA public GRANT ALL ON FUNCTIONS TO theopenpresenter_visitor;
