...
export const SetupScreen: React.FC<Props> = ({navigation}) => {
  ...
  }, [cookieLoading, cookie, navigation]);
            ...
            if (orgSlug && screenSlug) {
              axios(
                ...
                .then(async (response) => {
                  ...
                  await login(setCookieHeader[0], rootUrl, 'Player');
                })
                .catch((e) => {
    ...
    <View style={styles.container}>
      ...
      <View style={styles.row}>
        ...
        <View style={styles.rightPanel}>
          <View
            style={[styles.qrCard, {width: qrSize + 64, height: qrSize + 64}]}>
            {status === 'ready' && qrId && (
              <QRCode
                size={qrSize}
