...
const SongView = React.memo(({ song, onMoveUp, onMoveDown }: SongViewProps) => {
  ...
  return (
    <SongViewInner song={song} onMoveUp={onMoveUp} onMoveDown={onMoveDown} />
  );
});

const SongViewInner = React.memo(
