...
export default function Privacy() {
  return (
    <StandardWidth>
      <Box className="wmde-markdown" pt={{ base: 24, md: 28 }}>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              "We", "Us" or "Our" in this Agreement) refers to EPICAT LTD
              (Company no. 12264815).
            </p>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to TheOpenPresenter.com,
              accessible from{" "}
              <a
        ...
        <ul>
          <li>
            ...
            <p>
              We use the open source Plausible Analytics routed through our
              stats subdomain to count website visits, downloads, etc. No
              cookies are used and no personal data—not even an IP address or
              browser user agent—is stored.
            </p>
            <p>
              For more information on the privacy practices of Plausible, please
              visit the Plausible Data Policy web page:{" "}
              <a
        ...
        <p>
          ...
          third party for valuable consideration. TheOpenPresenter does not sell
          or rent Personal Data to marketers or unaffiliated third parties.
        </p>
        ...
        <ul>
          <li>
            ...
            <NextLink href="https://theopenpresenter.com/support/">
              https://theopenpresenter.com/support/
            </NextLink>
          </li>
          <li>
            By email:{" "}
            <a href="mailto:support@theopenpresenter.com">
