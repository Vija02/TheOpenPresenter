            ...
            <div className="wmde-markdown">
              ...
              <ul>
                ...
                <li>
                  <p>
                    ...
                    EPICAT LTD (Company no. 12264815).
                  </p>
                  <p>
              ...
              <ul>
                <li>
                  ...
                  <p>
                    We use the open source Plausible Analytics routed through
                    our stats subdomain to count website visits, downloads, etc.
                    No cookies are used and no personal data—not even an IP
                    address or browser user agent—is stored.
                  </p>
                  <p>
                    For more information on the privacy practices of Plausible,
                    please visit the Plausible Data Policy web page:{" "}
                    <a
              ...
              <p>
                ...
                TheOpenPresenter does not sell or rent Personal Data to
                marketers or unaffiliated third parties.
              </p>
